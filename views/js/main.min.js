...
0;b<document.querySelectorAll(".randomPizzaContainer").length;b++){var c,e=document.querySelectorAll(".randomPizzaContainer")[b];c=a;var d=e.offsetWidth,e=document.querySelector("#randomPizzas").offsetWidth,d=d/e;a:{switch(c){case "1":c=.25;break a;case "2":c=.3333;break a;case "3":c=.5;break a;default:console.log("bug in sizeSwitcher")}c=void 0}c=(c-d)*e;c=document.querySelectorAll(".randomPizzaContainer")[b].offsetWidth+c+"px";document.querySelectorAll(".randomPizzaContainer")[b].style.width=c}window.performance.mark("mark_end_resize");
